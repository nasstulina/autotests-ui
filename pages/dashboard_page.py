from components.navigation.navbar_component import NavbarComponents
...
class DashboardPage(BasePage):
    ...
    def check_student_chart_visible(self):
    ...
    def check_activities_chart_visible(self):
    ...
    def check_courses_chart_visible(self):
        expect(self.courses_title).to_be_visible()
        expect(self.courses_title).to_have_text('Courses')
        expect(self.courses_chart).to_be_visible()

    def check_scores_chart_visible(self):
